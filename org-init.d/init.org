...
(my-safe-require 'mu4e
  ...
  ;; デフォルトの送信メールアドレスを変更する
  (defvar mu4e-my-email-address "kai@gavo.t.u-tokyo.ac.jp"
    "Default mail address for mu4e.")
  (defadvice mu4e~compose-from-construct (around replace-my-address activate)
    "Replace a default mail address of mu4e from `user-mail-address'."
    (let ((user-mail-address mu4e-my-email-address))
      ad-do-it))
  ;; guide-key を使う
