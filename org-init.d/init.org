...
(use-package counsel :defer t
  ...
  (defun my-counsel-abbreviate-files (files)
...
This function is supposed to use with :filter-return advice."
  ...
  (advice-add 'counsel-recentf-candidates :filter-return #'my-counsel-abbreviate-files)
  (counsel-mode 1))
#+end_src
*** ivy-posframe
...
(use-package flycheck-posframe
  ...
  ;; workaround for https://github.com/alexmurray/flycheck-posframe/issues/27
  (advice-add 'next-line :before (lambda (&rest args) (flycheck-posframe-hide-posframe)))
  (advice-add 'previous-line :before (lambda (&rest args) (flycheck-posframe-hide-posframe)))
  )
#+end_src
** git-gutter-fringe
#+BEGIN_SRC emacs-lisp +n
