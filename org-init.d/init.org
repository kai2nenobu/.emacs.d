...
(use-package counsel :defer t
  ...
  ;; 高さ設定
  (add-to-list 'ivy-height-alist (cons 'swiper (ivy-my-height-ratio 0.6)))
  (add-to-list 'ivy-height-alist (cons 'counsel-recentf (ivy-my-height-ratio 0.5)))
  (add-to-list 'ivy-height-alist (cons 'counsel-yank-pop (ivy-my-height-ratio 0.5)))
  ;; counsel-rg関連
  (defun counsel-my-rg-toggle-hidden (_arg)
    ...
    (let* ((opt "--hidden")
           ...
           (prompt (if hidden-on "w/o hidden" "with hidden")))
