...
(setq time-stamp-format "%3a %3b %2d %02H:%02M:%02S %Z %:y") ; equivalent for date command
#+END_SRC
** 右クリックメニューを有効にする
...
org-mode 形式のファイルを変換し wordpress に投稿する．
#+BEGIN_SRC emacs-lisp
(my-safe-require 'org2blog
  (setq org2blog/wp-tags-list '("Emacs" "WordPress" "Uncategorized"))
  (setq org2blog/wp-blog-alist
        `(("wordpress"
           :url "http://www.kaichan.mydns.jp/wordpress/xmlrpc.php"
...
(my-safe-require 'guide-key
  (setq-default guide-key:show-key-sequence
                '("C-c C-e" "C-x v" "C-c p" "C-x RET" "C-x 8" "C-x 8 ^"
                  "C-q" "C-x r" "C-S-r" "C-x 4" "C-4" "C-S-a"
...
(my-safe-require 'auto-save-buffers
  ...
  (setq auto-save-buffers-exclude-regexp "init.el\\|^/\\(ssh\\|su\\|sudo\\):"))
