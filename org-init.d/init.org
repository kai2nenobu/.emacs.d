...
(when window-system
  ...
  (defvar my-font-alist '(("HackGen Console" . 14) ("Ricty" . 15) ("Ricty Diminished" . 15) ("ＭＳ ゴシック" . 12) ("hoge" . 3))
...
(use-package highlight-indent-guides :defer t
  ...
  (set-variable 'highlight-indent-guides-character (if (char-displayable-p #x23b8)
