...
(setq org-publish-project-alist
      `(("orghtml"
         :base-directory ,(concat org-directory "/wiki")
         :publishing-directory "/rubner-web:public_html/orghtml"
         :base-extension "org"
         ...
         :auto-postamble nil)
        ("images"
        :base-directory ,(concat org-directory "/wiki/img")
        :publishing-directory "/rubner-web:public_html/orghtml/img"
       ...
       ("others"
        ...
        :base-extension "css"
        :publishing-function org-publish-attachment)
       ("website" :components ("orghtml" "images" "others"))))
#+END_SRC
*** export 関連
#+BEGIN_SRC emacs-lisp
